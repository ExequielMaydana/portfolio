...
export default function Welcom() {
 ...
 animate-duration-[900ms] animate-delay-[500ms]">
      ...
      <h1 className="text-4xl font-black text-black textShadow sm:text-5xl lg:text-7xl animate-fade
 ...
 animate-duration-[900ms] animate-delay-[900ms]">
      ...
      <p className="font-medium text-black sm:w-4/5 sm:text-lg lg:text-xl animate-fade
 animate-duration-[900ms] animate-delay-[900ms]">
