...
export default function About() {
  return (
    <section
      className="w-full flex flex-col gap-4 p-4 lg:p-12 mb-12"
      id="about"
    >
      <HeaderSections title="Sobre mí" />
      <article className="w-full flex flex-col items-center justify-center text-center gap-8 lg:flex-row lg:items-start">
        ...
        <div className="w-full flex flex-col items-center justify-center text-center gap-12 lg:w-[60%]">
          <p className="font-medium sm:w-[90%] lg:w-full">
            {" "}
            ...
            ientos y habilidades técnicas que me pe base de conocimrmiten
            diseñar y construir aplicaciones web completas y eficientes.
            <br />
            <br />
