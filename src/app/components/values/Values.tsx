...
export default function Values() {
  return (
    <section className="w-full flex flex-col p-4 lg:p-12 mb-12">
      ...
      <p className="font-medium text-dimGray mt-2 mb-4 text-center md:w-[80%] md:text-xl md:text-center md:mb-6 lg:text-center">
      ...
      <article className="w-full flex flex-wrap items-center justify-center gap-6">
        {dataValues.map((data) => (
